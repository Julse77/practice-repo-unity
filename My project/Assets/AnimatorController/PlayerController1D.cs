...
public class PlayerController1D : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Shift 키를 안누르면 최대 0.5, Shift키를 누르면 최대 1까지 값이 바뀌게 됨
        float offset = 0.5f + Input.GetAxis("Sprint") * 0.5f;
        // 오른쪽 방향키를 누르면 forward가 +이지만 왼쪽 방향키를 누르면 forward가 -이기 때문에
        ...
        // 이동속도: Shift키를 안눌렀을 땐 walkSpeed, Shift키를 눌렀을 땐 runSpee값이 moveSpeed에 저장
